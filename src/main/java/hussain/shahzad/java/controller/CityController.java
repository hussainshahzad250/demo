...
public class CityController {
	...
	public Response<CityRequest> generateRequestJson() {
		return new Response<>(LoanApplicationResponseCode.SUCCESS.getMessage(), CityConverter.getSample(),
				HttpStatus.OK);
	}

	@PostMapping(produces = MediaType.APPLICATION_JSON_VALUE)
	public Response<Long> add(@RequestBody(required = true) CityRequest request) {
	...
	public Response<CityResponse> getById(@PathVariable(RestMappingConstants.ID) Long id) {
